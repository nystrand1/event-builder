...
export const RSVPForm = ({
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-yellow-100 to-pink-100">
      <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden">
        <div className="px-8 pt-8 pb-6 text-center">
          <Heart className="mx-auto h-12 w-12 text-pink-500 animate-pulse" />
          <h2 className="mt-4 text-3xl font-bold text-purple-600">{title || 'Wedding RSVP'}</h2>
